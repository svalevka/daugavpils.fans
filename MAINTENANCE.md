...
(понадобится аккаунт на GitHub и знакомство с git), зато подходит не
только для мелких правок текста, но и вообще для любых изменений —
точный технический процесс описан в [README.md](README.md).
