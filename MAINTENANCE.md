...
### Если нужно просто исправить уже существующую информацию

Если вы уже нашли группу или альбом на сайте и хотите поправить что-то в
уже написанном тексте — например, неточность в биографии, состав
участников или подпись к фото — для этого не нужно писать в Issues и
ждать ответа. Есть два способа, на выбор:

**Вариант 1. Через сайт, без регистрации и без git.** На странице
**[review.daugavpils.fans/submit](https://review.daugavpils.fans/submit)**
можно сразу предложить исправление текста, а также добавить новую
фотографию или видео к уже существующей группе или альбому — просто
выбрав файл на своём телефоне или компьютере. Предложение проверит один
...
в архиве, так что это может занять чуть больше времени. Это самый простой
способ — подходит всем.
