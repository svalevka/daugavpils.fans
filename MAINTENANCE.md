...
- **Описания** (названия групп, треклисты, биографии, кто в какой группе
  ...
  может кто угодно, без разрешения и без регистрации. Копия каждого
  описания также автоматически сохраняется на archive.org, рядом с
  файлами той же группы/альбома, по предсказуемому адресу — например,
  описание M. Spirit лежит по адресу
  [archive.org/download/daugavpils-fans-m-spirit/band.yaml](https://archive.org/download/daugavpils-fans-m-spirit/band.yaml)
  — так что эти тексты не зависят только от GitHub.
...
- Более того, рядом с записями каждой группы и каждого альбома на
  archive.org теперь автоматически хранится ещё и копия их текстового
  описания (то же самое, что лежит на GitHub) — так что даже сами
