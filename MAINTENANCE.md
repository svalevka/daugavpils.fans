...
3. что произойдёт, если Сергей (тот, кто сейчас всем этим занимается) по
   какой-то причине не сможет продолжать этим заниматься.
...
## Что будет, если Сергей не сможет продолжать этим заниматься
...
- Обе эти площадки — GitHub и archive.org — открыты для всех уже сейчас.
  ...
  без разрешения Сергея — потому что страницы уже публичные.
