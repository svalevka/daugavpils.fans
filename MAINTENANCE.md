...
Предложение проверит один из кураторов проекта. С текстовыми
исправлениями после одобрения всё происходит автоматически — они сразу
появляются на сайте. С фото и видео чуть иначе: после одобрения куратору
ещё нужно запустить публикацию файла в архив — обычно это одно нажатие
кнопки, но иногда куратор публикует файл вручную, — так что это может
