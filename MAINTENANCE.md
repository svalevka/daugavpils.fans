...
участников или подпись к фото — для этого не нужно писать в Issues или
ждать ответа: на странице **[review.daugavpils.fans](https://review.daugavpils.fans)**
можно сразу предложить исправление конкретного текста, без регистрации.
Предложение проверит один из кураторов проекта и, если всё верно,
исправление появится на сайте автоматически.
