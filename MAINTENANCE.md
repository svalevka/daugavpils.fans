...
**[review.daugavpils.fans](https://review.daugavpils.fans)** можно сразу
предложить исправление конкретного текста. Предложение проверит один из
кураторов проекта и, если всё верно, исправление появится на сайте
автоматически. Это самый простой способ — подходит всем.
