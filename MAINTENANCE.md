...
Музыка Даугавпилсской сцены годами существовала разрозненно — на
кассетах, дисках и жёстких дисках отдельных людей, без общего места, где
её можно было бы найти и сохранить. Этот проект решает именно эту
проблему: он сохраняет записи, фотографии и историю сцены в одном
открытом месте, пока они не потерялись безвозвратно.

Это некоммерческий волонтёрский архив — на сайте нет рекламы, подписок и
монетизации, никто на этом не зарабатывает. Материалы добавляют
участники сцены и её слушатели по собственной инициативе и
добросовестно — куратор физически не может лично связаться с каждой
группой и подтвердить каждую деталь перед публикацией. Если вы автор
записи или представляете группу и считаете, что что-то опубликовано
неверно или без вашего согласия — это решается быстро и без конфликта,
смотрите раздел «А можно так делать? Про лицензию» ниже.

Это работа одного человека на добровольных началах, в свободное время —
пожалуйста, имейте это в виду: мы здесь, чтобы сохранить музыку сцены, а
не чтобы с кем-то спорить.
...
4. Все принятые решения (одобренные и отклонённые заявки) фиксируются в журнале решений кураторов с хранением истории в течение 90 дней.
...
У каждого альбома в архиве указана лицензия Creative Commons — её
выбирает тот, кто добавляет альбом в архив (сам автор, другой участник
группы или кто-то из её окружения), как добросовестное заявление о том,
что запись можно свободно распространять (обычно с условием — не в
коммерческих целях и с указанием авторства). Куратор архива не проверяет
лично каждое такое заявление с самой группой перед публикацией — это
невозможно для архива, который пополняется силами сообщества. Если автор
считает, что лицензия указана неверно или он не давал такого согласия —
читайте ниже, что делать.

### Если вы автор и хотите убрать свою запись

Мы уважаем право автора решать судьбу своей музыки. Если вы автор (или
правообладатель) записи и хотите, чтобы её убрали из архива — напишите
нам, и мы отреагируем быстро. Перед снятием мы можем попросить
подтвердить авторство — это защищает архив от случайных или
недобросовестных запросов от посторонних людей, никак не связанных с
записью. До подтверждения запись может быть временно скрыта с сайта, но
не удаляется безвозвратно — если заявление окажется ошибочным, всё
восстанавливается без потерь.
