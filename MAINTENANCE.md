...
открываться, попробуйте этот адрес — там должно быть то же самое.

**И даже если исчезнут оба адреса, музыка и история группы всё равно не
будут потеряны.** Вот почему:
